...
public class CemEvent {
    ...
    public void testGetPeriodIndexSO2() {
        ...
        CemEvent event = null;
        try {
            if (getPeriodIndexSO2(event, 0, 1) != 0)
...
//	}
    ...
    public void testGetNumPeriodsNOx() {
        ...
        try {
            ...
            if (getNumPeriodsNOx(event) != 3)
                System.out.println("Wrong num NOx periods for event: " + event.toString());
            event = new CemEvent(dates[4]);
            if (getNumPeriodsNOx(event) != 3)
                System.out.println("Wrong num NOx periods for event: " + event.toString());
            event = new CemEvent(dates[7]);
            if (getNumPeriodsNOx(event) != 4)
                System.out.println("Wrong num NOx periods for event: " + event.toString());
            ...
            if (getNumPeriodsNOx(new CemEvent(dates[0], dates[1])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[0], dates[2])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[0], dates[3])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[0], dates[4])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[0], dates[5])) != 4 ||
                    getNumPeriodsNOx(new CemEvent(dates[0], dates[6])) != 4 ||
                    getNumPeriodsNOx(new CemEvent(dates[0], dates[7])) != 4 ||
                    getNumPeriodsNOx(new CemEvent(dates[0], dates[8])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[0], dates[9])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[0], dates[10])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[0], dates[11])) != 3 ||

                    getNumPeriodsNOx(new CemEvent(dates[1], dates[2])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[1], dates[3])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[1], dates[4])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[1], dates[5])) != 4 ||
                    getNumPeriodsNOx(new CemEvent(dates[1], dates[7])) != 4 ||
                    getNumPeriodsNOx(new CemEvent(dates[1], dates[8])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[1], dates[9])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[1], dates[11])) != 3 ||

                    getNumPeriodsNOx(new CemEvent(dates[3], dates[4])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[3], dates[5])) != 4 ||
                    getNumPeriodsNOx(new CemEvent(dates[3], dates[7])) != 4 ||
                    getNumPeriodsNOx(new CemEvent(dates[3], dates[8])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[3], dates[9])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[3], dates[11])) != 3 ||

                    getNumPeriodsNOx(new CemEvent(dates[4], dates[5])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[4], dates[7])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[4], dates[8])) != 2 ||
                    getNumPeriodsNOx(new CemEvent(dates[4], dates[9])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[4], dates[11])) != 3 ||

                    getNumPeriodsNOx(new CemEvent(dates[5], dates[7])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[5], dates[8])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[5], dates[9])) != 4 ||
                    getNumPeriodsNOx(new CemEvent(dates[5], dates[11])) != 4 ||

                    getNumPeriodsNOx(new CemEvent(dates[7], dates[8])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[7], dates[9])) != 4 ||
                    getNumPeriodsNOx(new CemEvent(dates[7], dates[11])) != 4 ||

                    getNumPeriodsNOx(new CemEvent(dates[8], dates[9])) != 3 ||
                    getNumPeriodsNOx(new CemEvent(dates[8], dates[11])) != 3 ||

                    getNumPeriodsNOx(new CemEvent(dates[9], dates[11])) != 3)
